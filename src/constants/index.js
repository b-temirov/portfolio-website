...
`Developed a Spring Boot server application for handling HTTP file uploads and implemented file validation using Apache POI based on System Requirements Specification (SRS).`,
`Upgraded documentation for backend service functions, including input data/file formats, database access, and interface design for Functional Specification Document (FSD).`],
  ...
  },
  {
    ...
    role: "Data Scientist",
    company: "Super Chain",
    description: [`Developed NLP solutions using LLMs (Llama 2, GPT-3.5 Turbo), focusing on fine-tuning and inference techniques such as LoftQ and Chain-of-Thought Prompting.`,
